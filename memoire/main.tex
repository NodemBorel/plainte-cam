...
\item À M. \textbf{NDJON MBOG THIERRY}, encadreur professionnel chez \textbf{Access Finance \& RH SARL}, pour son accompagnement terrain, ses conseils avisés et sa disponibilité tout au long de la réalisation de ce projet.

\item À l'ensemble des collaborateurs de \textbf{Access Finance \& RH SARL} pour leur accueil chaleureux et les conditions de travail offertes tout au long du stage.
...
\input{chapters/01_diagnostic}   % Chapitre 1
\input{chapters/02_realisation}  % Chapitre 2
\input{chapters/03_bilan}        % Chapitre 3
\input{chapters/04_conclusion}

% ── POSTLIMINAIRES ───────────────────────────────────────────
\appendix
\input{chapters/05_annexes}
\cleardoublepage
\phantomsection
