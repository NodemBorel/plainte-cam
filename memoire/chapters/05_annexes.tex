...
\figopt{ecran_depot_nature.png}{0.68}{Étape 1 — nature de l'infraction et cascade de localisation}{fig:man_depot_nature}

\figopt{ecran_depot_apercu.png}{0.68}{Étape 5 — aperçu de la déclaration avant signature}{fig:man_depot_apercu}
...
\figopt{ecran_suivi.png}{0.68}{Espace citoyen — suivi de l'avancement d'un dossier}{fig:man_suivi}
...
\figopt{ecran_cotation.png}{0.68}{Espace commissaire — cotation d'un dossier à un enquêteur}{fig:man_cotation}
...
\figopt{ecran_pv.png}{0.68}{Espace enquêteur — éditeur de procès-verbal, proposition révisable}{fig:man_pv}
