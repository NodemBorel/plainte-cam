...
Ce stage de six mois au sein de \textbf{Access Finance \& RH SARL} avait pour objectif de répondre à un défi concret : dématérialiser le dépôt et le traitement des plaintes citoyennes, qui reposaient jusqu'alors entièrement sur des échanges physiques et des pièces papier.
...
Une dernière perspective mérite d'être soulignée, car elle dépasse le périmètre initial. Le dépôt de plainte n'est pas propre à la police : la \textbf{gendarmerie} en reçoit également, et d'autres corps administratifs traitent des réclamations selon des logiques voisines. PlainteCam peut donc s'étendre à ces structures, à condition de rendre \textbf{paramétrable} ce qui leur est propre : les intitulés et les mentions légales des pièces produites, l'en-tête des documents, et le découpage territorial dont dépend le rattachement automatique. Le modèle de données s'y prête déjà : le référentiel des unités est une entité à part entière, et non une valeur codée en dur.
